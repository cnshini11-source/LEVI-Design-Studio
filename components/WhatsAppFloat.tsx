        ...
        >
          ...
          >
            ...
            <div className="relative z-10">
                {/* Official WhatsApp SVG - Increased size from 28 to 34 */}
                <svg width="34" height="34" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-sm">
