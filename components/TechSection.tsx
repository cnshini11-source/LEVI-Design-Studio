                ...
                >
                   ...
                   <div className="space-y-4">
                       <p className="text-lg text-slate-400 leading-relaxed font-light">
                           זה כואב בכיס: שילמתם על הקליק, הבאתם את הגולש עד לדלת, אבל אז הוא יצא בלי להשאיר עקבות.
                           <br className="hidden md:block" /><br className="hidden md:block" />
                           אנחנו עוצרים את הדימום הזה. המערכת שלנו מזהה מתי גולש מהסס ומגישה לו את הפתרון המדויק שיגרום לו להשאיר פרטים <strong className="text-white font-medium">כאן ועכשיו</strong>.
                       </p>
                   </div>
                </motion.div>
